...
<div class="main" id="app">
	...
	<header>
		...
		<div class="divide-bar" style="float: right;">
			<p style="color: white"><span style="font-weight: bold;">You are accessing</span> <a href="<?= $redirected?>" style="color: white"><?=  substr($redirected,0, 50)?> . . .</a></p>
		</div>
	</header>
	<div class="ads">
		<div class="ad-box">
	...
	<div class="content">
		...
		<iframe src="<?= $redirected ?>" class="prev_frame"></iframe>
	</div>
	<div class="footer">
	...
	<script type="text/javascript">   
	    function Redirect() 
	    {  
	        window.location= <?php echo '"'.$redirected.'"' ?>; 
	    } 
