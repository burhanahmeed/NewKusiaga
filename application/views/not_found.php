...
<div class="main" id="app">
	...
	<div class="content">
		<p style="color: white"><span style="font-weight: bold;">We could not find the link you're requested</span> <a href="/" style="color: white; padding: 7px; background-color: black;">Generate the New One?</a></p>
		<img src="aset/error.png">
	</div>
	<div class="ads">
		<div class="ad-box">
